...
# Creating Function for Saying
def say(text):
    engine = pyttsx3.init()
    engine.say(f"{text}")
    engine.runAndWait()

# Create function to take input as a voice command
def takecommand():
    r = sr.Recognizer()
...
# Checking Condition for Handling Errors
while True:
    print("Listening..........")
    query = takecommand()
    ...
    # Create a list Contain all folder name of your PC
    ...
    # Create a list which contain Application name which is in your PC 
    ...
    # create a variable which store your music file name or it's Directory
    Music_1 =["song","music"]
    ...
    # Use Date Time Module to Fetch Date and Time
    if f"what is the time".lower() in query.lower():
        ...
        with sr.Microphone() as source:
            ...
            try:
                ...
                print("You Said:", text)
                # it will automatic web search everything you said
